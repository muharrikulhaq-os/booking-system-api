...
func (h *UserHandler) List(c *fiber.Ctx) error {
	...
	data, total, err := h.svc.List(c.Context(), page, limit, queryString(c, "search"), queryInt32(c, "roleId"), nil, queryInt32(c, "departmentId"), c.Query("sortBy"), c.Query("sortOrder"))
	if err != nil {
		return err
	}
