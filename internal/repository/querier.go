...
type Querier interface {
	...
	CountMaintenance(ctx context.Context, resourceID sql.NullInt32) (int64, error)
	...
	CreateFuelExpenseBBM(ctx context.Context, arg CreateFuelExpenseBBMParams) (FuelExpense, error)
	CreateFuelExpenseListrik(ctx context.Context, arg CreateFuelExpenseListrikParams) (FuelExpense, error)
	...
	UpdateFuelExpenseBBM(ctx context.Context, arg UpdateFuelExpenseBBMParams) (FuelExpense, error)
	UpdateFuelExpenseListrik(ctx context.Context, arg UpdateFuelExpenseListrikParams) (FuelExpense, error)
