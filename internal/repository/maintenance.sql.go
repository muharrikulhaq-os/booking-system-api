...
SELECT mr.id, mr."vehicleId", mr."maintenanceTypeId", mr.description, mr.type, mr.status, mr."vendorName", mr."proofPhotos", mr.odometer, mr."totalCost", mr.location, mr."startDate", mr."endDate", mr."completedAt", mr."recordedById", mr."createdAt", mr."isAutoGenerated", r.name AS vehicle_name, v."plateNumber",
